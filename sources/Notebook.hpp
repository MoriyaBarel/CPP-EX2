...
namespace ariel
{
    ...
    public:
        ...
        void static check_throw_erase(const int page, const int row, const int column, Direction direction, const int length);
        void static check_throw_read(const int page, const int row, const int column, Direction direction, const int length);
    };
}
